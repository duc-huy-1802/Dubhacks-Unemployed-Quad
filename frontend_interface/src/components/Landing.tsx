    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[700px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-6 max-w-4xl">
          ...
          <Button 
            ...
            className="bg-white hover:bg-white/90 text-primary rounded-xl px-8 py-6 text-xl gap-3 shadow-2xl"
          >
            <Map size={28} />
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-center text-foreground mb-12">Get Involved</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <h3 className="text-foreground mb-3 text-center">I am an Organization</h3>
            ...
            >
              ...
              <h3 className="text-foreground mb-3 text-center">I am a Volunteer</h3>
              <p className="text-sm text-muted-foreground mb-6 text-center">
            ...
            >
              ...
              <h3 className="text-foreground mb-3 text-center">Report Deforestation</h3>
              <p className="text-sm text-muted-foreground mb-6 text-center">
      ...
      <section className="py-20 px-6 bg-muted">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-center text-foreground mb-4">Why Releaf?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-foreground mb-2">Detect</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-foreground mb-2">Report</h3>
              <p className="text-muted-foreground">
            ...
            <div className="text-center">
              ...
              <h3 className="text-foreground mb-2">Restore</h3>
              <p className="text-muted-foreground">
      ...
      <section className="py-20 px-6 bg-secondary text-white">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-4xl md:text-5xl text-white mb-2">1.2M+</div>
              <p className="text-white/70">Trees Planted</p>
            </div>
            <div>
              <div className="text-4xl md:text-5xl text-white mb-2">850+</div>
              <p className="text-white/70">Active Events</p>
            </div>
            <div>
              <div className="text-4xl md:text-5xl text-white mb-2">15K+</div>
              <p className="text-white/70">Volunteers</p>
            </div>
            <div>
              <div className="text-4xl md:text-5xl text-white mb-2">3,400+</div>
