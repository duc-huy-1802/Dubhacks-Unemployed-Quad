    ...
    try {
      await emailjs.send(
        ...
        "template_17us8im",
        {
          ...
          to_email: "minhtri@uw.edu", // <-- your inbox
      ...
      <div className="flex flex-col items-center justify-center max-w-md p-5 mx-auto border border-white/10 rounded-2xl bg-primary">
        <div className="flex flex-col items-start w-full gap-5 mb-10">
          ...
          <p className="font-normal text-neutral-400">
            Whether you're looking to build a web app, improve an existing platform,
            or collaborate on physics-powered simulations, I’m here to help.
          </p>
        </div>
        ...
        <form className="w-full" onSubmit={handleSubmit}>
          ...
          <div className="mb-5">
            ...
            <input
              ...
              className="field-input field-input-focus"
              placeholder="johndoe@email.com" autoComplete="email"
